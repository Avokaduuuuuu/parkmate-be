...
CREATE
TYPE lot_status AS ENUM ('PENDING', 'INACTIVE', 'MAINTENANCE');
CREATE
TYPE spot_status AS ENUM ('AVAILABLE', 'OCCUPIED', 'RESERVED', 'MAINTENANCE', 'DISABLED');
CREATE
TYPE vehicle_type AS ENUM (
	'BIKE',           -- Bicycle
...
CREATE
TYPE session_type AS ENUM ('MEMBER', 'OCCASIONAL');
CREATE
TYPE auth_method AS ENUM (
	'BLE_PRESENCE',
	'NFC_CARD',
	'QR_CODE',
	'OTHER'
...
INSERT INTO parking_lot (id, partner_id, name, street_address, ward, city, latitude, longitude, total_floor,
                         operating_hours_start, operating_hours_end, is_24_hour, boundary_top_left_x,
                         boundary_top_left_y, boundary_width, boundary_height, status)
VALUES (1, 101, 'Diamond Plaza Parking', '34 Le Duan Street', 'Ben Nghe Ward', 'Ho Chi Minh City', 10.7827500,
        106.6986700, 3, '06:00:00', '23:00:00', FALSE, 0.00, 0.00, 100.00, 80.00, 'PENDING'),
       (2, 102, 'Bitexco Financial Tower Parking', '2 Hai Trieu Street', 'Ben Nghe Ward', 'Ho Chi Minh City',
        10.7716800, 106.7041900, 5, '00:00:00', '23:59:59', TRUE, 0.00, 0.00, 120.00, 90.00, 'PENDING'),
       (3, 103, 'Vincom Center Parking', '70-72 Le Thanh Ton Street', 'Ben Nghe Ward', 'Ho Chi Minh City', 10.7795300,
        106.7020400, 2, '07:00:00', '22:00:00', FALSE, 0.00, 0.00, 80.00, 60.00, 'INACTIVE'),
       (4, 104, 'Saigon Centre Parking', '65 Le Loi Boulevard', 'Ben Nghe Ward', 'Ho Chi Minh City', 10.7738200,
        106.7009800, 4, '06:30:00', '22:30:00', FALSE, 0.00, 0.00, 110.00, 85.00, 'PENDING'),
       (5, 105, 'Landmark 81 Parking', '208 Nguyen Huu Canh Street', 'Ward 22', 'Ho Chi Minh City', 10.7945600,
        106.7218900, 6, '00:00:00', '23:59:59', TRUE, 0.00, 0.00, 150.00, 100.00, 'MAINTENANCE');

-- Insert lot capacities
INSERT INTO lot_capacity (lot_id, vehicle_type, capacity, support_electric_vehicle)
VALUES
