...
CREATE
TYPE device_os AS ENUM ('ANDROID', 'IOS');
CREATE
...
CREATE
TYPE reservation_status AS ENUM ('PENDING', 'ACTIVE', 'COMPLETED', 'CANCELLED', 'EXPIRED');
CREATE
TYPE account_role AS ENUM ('ADMIN', 'PARTNER_OWNER', 'PARTNER_STAFF', 'MEMBER');
CREATE
TYPE account_status AS ENUM ('PENDING_VERIFICATION', 'ACTIVE', 'SUSPENDED', 'DELETED');
CREATE
TYPE partner_status AS ENUM ('APPROVED', 'SUSPENDED', 'DELETED');
CREATE
TYPE registration_status AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
