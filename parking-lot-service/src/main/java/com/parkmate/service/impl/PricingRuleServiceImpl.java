...
import com.parkmate.entity.ParkingAreaEntity;
...
import com.parkmate.mapper.PricingRuleMapper;
import com.parkmate.repository.ParkingAreaRepository;
import com.parkmate.repository.ParkingLotRepository;
import com.parkmate.repository.PricingRuleRepository;
import com.parkmate.service.PricingRuleService;
...
public class PricingRuleServiceImpl implements PricingRuleService {
    ...
    public PricingRuleResponse createPricingRule(Long parkingLotId, PricingRuleCreateRequest request) {
        ...
        if (request.areaId() != null) {
            ParkingAreaEntity parkingAreaEntity = parkingAreaRepository.findById(request.areaId())
