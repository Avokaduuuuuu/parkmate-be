...
import com.parkmate.default_pricing_rule.DefaultPricingRuleMapper;
...
@Mapper(
        ...
        uses = {FloorMapper.class, PricingRuleMapper.class, LotCapacityMapper.class, ImageMapper.class, DefaultPricingRuleMapper.class}
)
