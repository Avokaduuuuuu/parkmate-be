...
public class ParkingLotController {
    ...
    public ResponseEntity<?> fetchAvailableSpots(
            @PathVariable Long id,
            @Parameter(example = "2025-11-04T11:00:00") LocalDateTime reservedFrom,
            @Parameter(example = "360") Integer assumedStayMinute,
            @Parameter VehicleType vehicleType
    ) {
        return ResponseEntity.ok(ApiResponse.success(parkingLotService.countAvailableSpot(id, reservedFrom, assumedStayMinute, vehicleType)));
    }
