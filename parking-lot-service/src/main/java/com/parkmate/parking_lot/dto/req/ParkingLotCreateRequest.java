...
public record ParkingLotCreateRequest(
        ...
        @NotNull(message = "Parking Lot Address must not be null")
        ...
        @NotNull(message = "Parking Lot Ward must not be null")
        ...
        @NotNull(message = "Parking Lot's latitude must be defined")
        ...
        @NotNull(message = "Parking Lot's longitude must be defined")
        ...
        @NotNull(message = "Must define total floors of the parking lot")
        ...
        @NotNull(message = "Must define the open time")
