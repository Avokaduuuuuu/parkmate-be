package com.parkmate.floor_capacity.dto.req;
...
@Schema(
        name = "ParkingFloorCapacityCreateRequest",
        description = "Request payload for defining capacity configuration for a specific vehicle type on a floor"
)
public record FloorCapacityCreateRequest(
