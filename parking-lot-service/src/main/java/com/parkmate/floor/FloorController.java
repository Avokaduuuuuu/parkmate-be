...
public class FloorController {
    ...
    public ResponseEntity<?> getFloorSubscriptionAvailability(
            @RequestParam Long parkingLotId,
            @RequestParam LocalDateTime startDate,
            @RequestParam VehicleType vehicleType,
            @RequestParam LocalDateTime endDate
    ) {
        return ResponseEntity.ok(ApiResponse.success("Fetch floor subscription availability successfully", floorService.getSubscriptionAvailability(parkingLotId, vehicleType, startDate, endDate)));
    }
}